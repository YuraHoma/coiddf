...
FIELD = {
    'title': 'повна назва',
    'shortTitle': 'коротка назва (вкладка браузера)',
...
instr = [
    ...
    ('', ''),
    ('Підказки щодо довжини', 'h2'),
    ('• «коротка назва (вкладка браузера)» — до 50 символів, її показує Google у результатах пошуку.', ''),
    ('• «короткий опис» — 2–3 речення, приблизно як в українському оригіналі.', ''),
    ('• Решта тексту — без обмежень, орієнтуйтесь на оригінал.', ''),
    ('', ''),
